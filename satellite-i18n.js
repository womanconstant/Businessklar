...
(function (global) {
  ...
  var STR = {
    de: {
      ...
      contact_title: 'Kontakt', contact_lead: 'Formular ausfüllen — Thema und Text gehen per E-Mail-Programm (mailto).',
      ...
      contact_message: 'Nachricht', contact_body_ph: 'Anfrage kurz beschreiben', contact_submit: 'E-Mail öffnen', contact_fill: 'Alle Felder ausfüllen.',
      contact_note: 'Versand über Ihr E-Mail-Programm. Empfängeradresse in den Produkteinstellungen setzen.',
    ...
    en: {
      ...
      contact_title: 'Contact us', contact_lead: 'Fill in the form — subject and body open in your mail client (mailto).',
      ...
      contact_message: 'Message', contact_body_ph: 'Briefly describe your request', contact_submit: 'Open email', contact_fill: 'Fill in all fields.',
      contact_note: 'Sending uses your email app. Set the recipient in product settings or in page code.',
    ...
    ru: {
      ...
      contact_title: 'Связаться с нами', contact_lead: 'Заполните форму — тема и текст уйдут на вашу почту через почтовый клиент (mailto).',
      ...
      contact_message: 'Сообщение', contact_body_ph: 'Кратко опишите запрос', contact_submit: 'Открыть письмо', contact_fill: 'Заполните все поля.',
      contact_note: 'Отправка идёт через ваш почтовый клиент. Адрес получателя задайте в настройках продукта или в коде страницы.',
