...
(function (global) {
  ...
  var activityComplianceRules = [
    ...
    { key: 'buchhaltung_eu', keywords: ['buchhaltung', 'buchhalter', 'lohn', 'финбух'], severity: 'medium', requires_license: false, requires_registration: true, requires_degree: false, requires_recognition: false, requires_meisterbrief: false, authority_type: 'IHK', link_override: null },
